export default `
  ...
  <li>If you need to create a playlist, you can check the "Author Info" section of this app, or <a href="https://github.com/WeWatchWall/stark-player/blob/main/standalone/example_playlists/playlist.zip?raw=true" target="_blank">download the example playlist</a>.</li>
  ...
  <li>Then, turn up the volume on your device and follow the on-screen instructions.</li>
  </ol>
