export default {
  part1: `
    <ol>
    <li>This section describes the creation process for WWWall-compatible playlists. You can <a href="https://github.com/WeWatchWall/stark-player/blob/main/standalone/example_playlists/playlist.zip?raw=true" target="_blank">download the example playlist here</a>.</li>
