export default {
  part1: `
    <ol>
    <li>This section describes the creation process for WWWall-compatible playlists. You can <a href="https://github.com/WeWatchWall/stark-player/blob/main/example_playlists/playlist_medium.zip" target="_blank">download the example playlist here</a>.</li>
